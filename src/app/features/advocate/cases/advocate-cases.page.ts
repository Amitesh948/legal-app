...
@Component({
  ...
  templateUrl: './advocate-cases.page.html',
  styleUrl: './advocate-cases.page.scss'
})
export class AdvocateCasesPage implements OnInit {
  cases: any[] = [];
  loading = true;
  error = false;
  ...
  goToDetail(id: string | number) {
    this.router.navigate(['/advocate/cases', id]);
  }
}
